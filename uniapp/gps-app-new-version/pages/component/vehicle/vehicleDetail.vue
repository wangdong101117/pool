<template>
    <view class="vehicle-detail-container" ref="vehDetail">
        <view class="content">
            ...
            <uni-combox label="发动机型号：" :value="vehicleData.engine_model" :disabled="true" v-model="vehicleData.engine_model"
            ...
            <uni-combox label="车辆型号：" :value="vehicleData.model" :disabled="true" v-model="vehicleData.model" placeholder="未选择..."
                codeType="tlt_vehicle_model_available"></uni-combox>
            <view class="list-item">
                <text>车架号：</text>
