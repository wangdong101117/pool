        ...
        <uni-popup class="fullscreen-popup" :show="show_condition" type="center" :custom="true" :mask-click="false">
            <view class="uni-tip uni-tip-fullscreen">
                ...
                <view style="padding: 20rpx; text-align: center;" class="content">
                    ...
                    <view v-show="current_value === 2 || current_value === 3" style="border-bottom: 1px solid #ccc; display: flex; font-size: 28rpx;">
                    ...
                    <view v-show="current_value === 0 || current_value === 1" style="border-bottom: 1px solid #ccc; display: flex; font-size: 28rpx;">
                        <text>选择日期:</text>
