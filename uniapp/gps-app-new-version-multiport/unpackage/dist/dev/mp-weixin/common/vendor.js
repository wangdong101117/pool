...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var mixin = {
  ...
  methods: {
    ...
    toastRequestErr: function toastRequestErr(data) {
      var code = data['error_code'];
      var desc = data['error_desc'];
      if (code === undefined) {
        if (typeof data === 'string' && data.includes('error_code')) {
          var s_data = data.split('==>')[0];
          var errorData = JSON.parse(s_data.concat('"}'));
          uni.showToast({
    ...
    addEventListenerComBoxToggle: function addEventListenerComBoxToggle() {var _this = this;
      this.$nextTick(function () {
        uni.$on('comBoxToggle', _this.callBack);
      });
    },
    removeEventListenerComBoxToggle: function removeEventListenerComBoxToggle() {
